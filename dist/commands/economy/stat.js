...
exports.earnings = {
    ...
    async execute(message, client, args) {
        ...
        let eE = `${(u.generators.energy.renewable * 100) + (u.generators.energy.hotfusion * 1000) + (u.generators.energy.coldfusion * 20000)}`;
        ...
        return message.channel.send(new discord_js_1.MessageEmbed()
            ...
            .addFields({ name: 'Gross Taxes', value: `${pE} ${u.resources.currencyname}`, inline: true }, { name: 'Gross Money Consumption', value: `${pC}`, inline: true }, { name: 'Net Money', value: `${parseInt(pE.split(" - ")[0]) - pC} to ${parseInt(pE.split(" - ")[1]) - pC}`, inline: true }, { name: 'Gross Food', value: `${fE}`, inline: true }, { name: 'Gross Food Consumption', value: `${fC}`, inline: true }, { name: 'Net Food', value: `${parseInt(fE) - fC}`, inline: true }, { name: 'Gross Metal', value: `${mE}`, inline: true }, { name: 'Gross Metal Consumption', value: `${mC}`, inline: true }, { name: 'Net Metal', value: `${parseInt(mE) - mC}`, inline: true }, { name: 'Gross Energy', value: `${eE}`, inline: true }, { name: 'Gross Energy Consumption', value: `${eC}`, inline: true }, { name: 'Net Energy', value: `${parseInt(mE) - eC}`, inline: true })
            .setFooter("blitzwolfz#9338", "https://cdn.discordapp.com/avatars/239516219445608449/12fa541557ca2635a34a5af5e8c65d26.webp?size=512"));
    }
};
