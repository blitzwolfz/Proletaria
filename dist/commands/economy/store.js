    ...
    async execute(message, client, args) {
        ...
        if (args[0].toLowerCase() === "military") {
            const militaryStore = new discord_js_1.MessageEmbed()
                ...
                .addFields({ name: `Your balance:`, value: `${(_a = (await db_1.getUser(message.author.id))) === null || _a === void 0 ? void 0 : _a.resources.money} ${(_b = (await db_1.getUser(message.author.id))) === null || _b === void 0 ? void 0 : _b.resources.currencyname}`, inline: false }, { name: '\u200b', value: '\u200b' }, { name: `Recuirt Soldiers:`, value: `Costs 1.5k. Recruit loyal citizens to fight for the motherland.`, inline: true }, { name: `Private Corpo Soldiers:`, value: `Costs 12.5k. A Private Corporation will provide you with a soldier.`, inline: true }, { name: '\u200b', value: '\u200b' }, { name: `Build a ship:`, value: `Costs 10.5k. Build ships to strengthen your Naval power.`, inline: true }, { name: `Private Corpo Ship:`, value: `Costs 25.5k. A Private Corporation will provide you with a ship.`, inline: true })
                .setColor("RED");
...
exports.buy = {
    ...
    async execute(message, client, args) {
        if (args.length === 0) {
            message.channel.send(`Please check \`${await (await db_1.getServer(message.guild.id)).prefix}store\` to see items availabe`);
        }
    }
};
