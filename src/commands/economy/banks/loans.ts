...
export const applyloans: Command = {
    name: "loan-apply",
...
export const loanTerms: Command = {
    name: "loan-terms",
    ...
    async execute(message: Message, client:Client, args: string[], ownerID:string){
        await message.channel.send(
            ...
            .addFields(
                {name:"APR", value:"APR in the game stands for the interest rate you are paying.\n"+
...
export const marketoffer: Command = {
    name: "market-offer",
